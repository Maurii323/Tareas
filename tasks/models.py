...
class Task(models.Model):
    ...
    descripcion = models.TextField(blank=True)  # determina si el campo es requerido en un formulario,si no se pasa una descripcion el campo va a ser vacio
    ...
    importante = models.BooleanField(default=False)  # por defecto el valor es falso
